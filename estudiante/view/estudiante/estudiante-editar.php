...
<div>
<label>Nombre</label>
<input type="text" name="nombre-form" value="<?php echo $est->nombre; ?>"
placeholder="Ingrese su nombre"/>
</div>
<div>
<label>Apellido</label>
<input type="text" name="apellido-form" value="<?php echo $est->apellido;
?>" placeholder="Ingrese su apellido"/>
</div>
<div>
<label>Correo</label>
<input type="text" name="email-form" value="<?php echo $est->email; ?>"
